...
const EditStudentModal: React.FC<EditStudentModalProps> = ({ student, studentId, classroomId }) => {
    ...
    const handleSubmitEditStudent = async () => {
        await editarStudent(studentId, { id: studentId, name, image_url: imageUrl, frequency });
