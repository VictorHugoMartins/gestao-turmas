...
const createClassroom = (req: Request, res: Response) => {
  ...
  const classroomExistente = classrooms?.find(
  ...
  res
    .status(201)
    .json({ message: "Turma criada com sucesso!", data: novaClassroom });
};
...
const updateClassroom = (req: Request, res: Response) => {
  ...
  res
    .status(200)
    .json({ message: "Turma atualizada com sucesso!", data: classroom });
};
...
const listClassrooms = (req: Request, res: Response) => {
  ...
  res.json({
    ...
    data: [classroomResumo, ...classrooms],
  });
};

export { createClassroom, updateClassroom, deleteClassroom, listClassrooms };
